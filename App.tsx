...
import { ChartBarIcon, PuzzleIcon, LinkIcon, TrendingUpIcon, TargetIcon, LightbulbIcon, ShareIcon, CheckIcon, DeveloperIcon } from './components/Icons';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      {!viewOnlyAnalysis && (
        <footer className="text-center mt-12 text-sm text-gray-500 flex items-center justify-center space-x-2">
            <DeveloperIcon className="w-5 h-5 text-green-400/70" />
            <span>Developed by: Noor Khan From Skyalgo.ai</span>
        </footer>
      )}
    </div>
  );
